  ...
  return (
    <div className="p-8 min-h-screen flex flex-col">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="p-6 border rounded-lg shadow flex flex-col justify-between">
          <div>
        ...
        <div className="p-6 border rounded-lg shadow flex flex-col justify-between">
          ...
          <Link href="/journal">
            <button className="mt-4 px-4 py-2 bg-cyan-500 text-white rounded hover:bg-cyan-600 w-full">
              Journal öffnen
            </button>
          </Link>
        </div>
